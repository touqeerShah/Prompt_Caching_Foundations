...
def scenario_semantic_reuse_pressure() -> List[Operation]:
    return [
        Operation(0,  "rag:a1", 1, [1.00, 0.00, 0.00]),
        Operation(1,  "rag:a2", 1, [0.99, 0.01, 0.00]),
        Operation(2,  "rag:b1", 1, [0.00, 1.00, 0.00]),
        Operation(3,  "rag:c1", 1, [0.00, 0.00, 1.00]),

        # reuse some keys
        Operation(4,  "rag:a1", 1, [1.00, 0.00, 0.00]),
        Operation(5,  "rag:b1", 1, [0.00, 1.00, 0.00]),

        # new redundant arrivals
        Operation(6,  "rag:a3", 1, [0.98, 0.02, 0.00]),
        Operation(7,  "rag:a4", 1, [0.97, 0.03, 0.00]),

        # reuse again
        Operation(8,  "rag:a1", 1, [1.00, 0.00, 0.00]),
        Operation(9,  "rag:b1", 1, [0.00, 1.00, 0.00]),

        # more pressure
        Operation(10, "rag:a5", 1, [0.96, 0.04, 0.00]),
        Operation(11, "rag:d1", 1, [0.00, 0.70, 0.70]),
    ]